---
title: "Garden Crop Rotation: 10 Simple Rules for Healthier Vegetables"
excerpt: "10 crop rotation rules every vegetable gardener should know: the 4 plant families, the 4-year plan, what happens if you plant tomatoes in the same spot twice, and why legumes always come before brassicas."
...
Beans and peas fix nitrogen in the soil. Broccoli and cabbage are nitrogen hogs. Plant legumes in year 1, leave the roots in the soil (they contain nitrogen-fixing nodules), and plant brassicas in year 2. The nitrogen transfer is not instant — it takes 4-6 months for soil microbes to mineralize the legume residue. This is the most nutrient-efficient sequence in the rotation.

## 4. Tomatoes Should Never Follow Tomatoes — Minimum 3-Year Gap

Tomato blight spores survive 3 years in soil. Fusarium and Verticillium wilt survive 5+ years. A 4-year rotation between tomatoes in the same soil is the minimum for disease prevention. If blight appears, extend to 5+ years for that specific bed. This is the garden rule that hurts most — and matters most.

## 5. The 4-Bed, 4-Year Plan Is the Gold Standard

Year 1: Bed 1 Legumes → Bed 2 Brassicas → Bed 3 Solanaceae → Bed 4 Roots/Alliums/Squash. Year 2: shift all forward one bed. By year 4, every family has been in every bed. Draw a simple map in a notebook. Your 2028 self will thank your 2026 self.

## 6. Cover Crops Turn a 4-Year Rotation Into a Continuous Soil-Building System

After harvesting beans in August, sow buckwheat. It grows for 8 weeks, winter-kills at 32°F, and leaves 2-3 tons of organic matter per acre. Till the residue in spring. Winter rye is the cold-hardy alternative — sow in September, till in at 6-12 inches in April. Cover crops between vegetable crops add organic matter, suppress weeds, and prevent erosion.
...
## 8. Container Soil Must Be Rotated Too — Same Rules Apply

Dump soil onto a tarp, remove roots, use for a different plant family next year. Tomato soil → beans. Bean soil → greens. Greens soil → back to tomatoes. Add 30% fresh compost and fertilizer when reusing. Do not reuse soil for the same family without amending and "resting" it.

## 9. Raised Beds Make Rotation Easy — They Are Already Physically Separated
