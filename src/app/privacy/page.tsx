...
export const metadata: Metadata = {
  title: "Privacy Policy | Gardening Tips",
  description: "Privacy policy for Gardening Tips. Learn how we handle your data.",
};
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert max-w-none space-y-4">
        ...
        <h2>3. Contact</h2>
        <p>For privacy concerns, email us at contact@gardeningtips.com.</p>
      </div>
    </div>
  );
}
